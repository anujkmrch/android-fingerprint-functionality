...
public class SetActivity extends AppCompatActivity implements FM220_Scanner_Interface {
...
//                DisableCapture();
                Toast.makeText(SetActivity.this, "Clicking the stuff", Toast.LENGTH_SHORT).show();
...
//              String template match example using FunctionBAse64 function .....
                FunctionBase64();
            }
        });
    }
...
//                  to match the file from the server
                    ...
                    /**
                     * Block of code is responsible for making it up
                     */
                    if(idView.getText() != null)
                    {
                        Functionality.SetFingerPrint(SetActivity.this, result.getScanImage(), idView.getText().toString());
                    } else {
                        Toast.makeText(SetActivity.this, "You did not entered the ID", Toast.LENGTH_SHORT).show();
                    }
